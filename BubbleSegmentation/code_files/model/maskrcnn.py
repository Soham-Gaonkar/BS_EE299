...
def load_maskrcnn_model(num_classes, pretrained=True):
    """
    ...
    # Modify the first convolution layer to accept 1 input channel (grayscale)
    # The original conv1 is for 3 channels: in_channels=3, out_channels=64, kernel_size=7
    # For grayscale images, we'll change in_channels=1
    conv1 = torch.nn.Conv2d(1, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)

    # Apply this modified conv1 to the backbone
    backbone.body.conv1 = conv1
